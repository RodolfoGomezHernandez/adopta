...
SECRET_KEY = 'django-insecure-u4fgz3$!2-bg-(&yx!)6ukin)6no99n4724rfezf#l!3a+_r@t'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], # indicamos donde encontrar las plantillas
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
